#!/bin/sh
# THIS SCRIPT INSTALLS THE PAIR_NEQUIP LAMMPS
...
conda remove -n lammps_nequip --all -y
conda create -n lammps_nequip python=3.10 -y
conda activate lammps_nequip

################################################################## LAMMPS INSTALLATION ##################################################################
# Location env variables PLEASE CHANGE THIS ACCORDINGLY
